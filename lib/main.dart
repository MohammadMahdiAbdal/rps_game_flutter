        ...
        children: [
          ...
          Card(
            child: Padding(
              padding: const EdgeInsets.all(18.0),
              child: Text(
                'این بازی با کلی ذوق و با استفاده از فریم‌ورک قدرتمند فلاتر توسط گروه احسان محمدی ساخته شده. هدفمون این بود که یه بازی ساده ولی خیلی سرگرم‌کننده و باحال بسازیم که لبخند رو لبتون بیاره.\n\nنسخه: 2.1.0\n\nهر گونه بازخورد یا ایده‌ای دارید، خوشحال میشیم بشنویم!',
                textAlign: TextAlign.center,
